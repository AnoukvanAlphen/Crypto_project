...
class PriceChecker():
    ...
    def addLevel(self):
        try:
            ...
            newvalue = float(input('please enter a new level: '))
            self.levelsList.append(newvalue)
        except:
        ...
        try:
            ...
            with open("Readfile.txt", "r") as file:
                for line in file:
                    ...
                    self.levelsList.append(float(stripped_line))
    ...
    def addLevel(self):
        try:
            self.levelsList.append(float(input('Enter a new level: ')))
        except:
    ...
    def removeLevel(self):
        try:
            del self.levelsList[self.levelsList.index(float(input('Please enter an existing level: ')))]
        except:
            print('Please enter a number')
    ...
    def monitorLevels(self):
        ...
        for price in self.levelsList:
            sublist = []
            sublist.append = ['Price level: ' + self.getBitMexPrice, self.getBitMexPrice ]
        ...
        # Append the sub-List to displayList.
        sublist = []
        sublist.append = ['Price level: ' + self.previousPrice, self.previousPrice ]
        displayList.append = sublist
        ...
        # Append the sub-List to displayList.
        sublist = []
        sublist.append = ['Price level: ' + self.currentPrice, self.currentPrice ]
        displayList.append = sublist 

        if self.currentPrice > self.previousPrice:
            print(colored(self.currentPrice, 'green'))

        if self.currentPrice < self.previousPrice:
            print(colored(self.currentPrice, 'red'))

        if self.currentPrice == self.previousPrice:
            print(colored(self.currentPrice, 'blue'))

        # Sort displayList using the SECOND item (price) in its sub-lists
        displayList.sort(key=sublist)
        return displayList
    ...
    def removeLevel(self):
        try:
            ...
            remove_value = input('input level to remove: ')
            self.levelsList.remove(float(remove_value))    
        except:
            # Print and error message if the user entered invalid input
            ValueError
            print('invalid input')
